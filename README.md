...
> "I'm like the Starmer of Computer Science; I say I'm going to write something, then decide not to."

I use TypeScript, Python, C#, and Lua.

Unlike the fuckwit I stole this README format from (jk lol), I do actually use linux. I'm too stupid to even install Arch or Gentoo, though.

Half of my code doesn't work because I can't be bothered to maintain it (or to make it work in the first place, honestly).

Have fun reading my code, because even I don't understand it half the time! (That's not a good thing, is it?)
